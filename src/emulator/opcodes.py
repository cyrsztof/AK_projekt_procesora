...
opcodes = {
    ...
    0x17: Opcode(name='OR', value=0x17, argc=2, execute=OR),
    0x18: Opcode(name='AND', value=0x18, argc=2, execute=AND),
    0x19: Opcode(name='XOR', value=0x19, argc=2, execute=XOR),
    0x1a: Opcode(name='NOT', value=0x1a, argc=1, execute=NOT),
    0x1b: Opcode(name='SHL', value=0x1b, argc=2, execute=SHL),
    0x1c: Opcode(name='SHR', value=0x1c, argc=2, execute=SHR),
